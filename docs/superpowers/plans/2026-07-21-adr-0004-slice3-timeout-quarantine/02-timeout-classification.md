# Task 2: `EXTRACT_ERR_TIMEOUT` — health-gated, shrink-first classification
...
**Interfaces:**
- Consumes: `LlmTimeoutError` from Task 1; `LlmCancelledError` from slice 2.
...
- `LlmCancelledError` (slice 2's shutdown path) is caught in the engine right next to
