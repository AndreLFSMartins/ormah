...
from tests.test_background.test_session_watcher import (  # noqa: E402
    _JUDGE_PATCH as _LLM_PATCH,
)

# local-main only: a queued PR repointed _LLM_PATCH at ingest_llm_generate and gave
# the feedback judge its own _JUDGE_PATCH. On upstream/main one constant covers both,
# which is why the contribution branch (PR #273) imports _LLM_PATCH directly. Taking
# the upstream version on a future sync-down will fail loudly here, not silently.
