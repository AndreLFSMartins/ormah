...
class MemoryEngine:
    ...
    def get_self(self, space: str | None = None) -> str:
        ...
        _ONBOARDING_NUDGE = (
            ...
            "- What kinds of help are most useful to them, phrased in a neutral, natural way\n"
            ...
            "- Light personal interests only if it fits naturally; do not ask about family, friends, or "
            "close relationships\n\n"
